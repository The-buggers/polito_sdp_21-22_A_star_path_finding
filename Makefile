...
target: main.o Graph.o ST.o PQ.o Position.o Astar.o
	gcc -Wall -g -o ./build/graphtest ./build/main.o ./build/Graph.o ./build/ST.o ./build/PQ.o ./build/Position.o ./build/Astar.o
...
Position.o: Position.c Position.h
	gcc -Wall -g -c Position.c -o ./build/Position.o
