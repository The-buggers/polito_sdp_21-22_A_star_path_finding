...
\begin{thebibliography}{9}
  \bibitem{texbook}
  PNBA*: A parallel bidirectional heuristic search algorithm. (n.d.). Retrieved September 7, 2022, from https://homepages.dcc.ufmg.br/~chaimo/public/ENIA11.pdf
  \bibitem{texbook}
  %Parallel A* graph search - massachusetts institute of technology. (n.d.). Retrieved September 7, 2022, from https://people.csail.mit.edu/rholladay/docs/parallel_search_report.pdf
  \bibitem{texbook}
  %Heuristics. (n.d.). Retrieved September 7, 2022, from http://theory.stanford.edu/~amitp/GameProgramming/Heuristics.html
  \bibitem{texbook}
  %Wikimedia Foundation. (2022, August 18). A* search algorithm. Wikipedia. Retrieved September 7, 2022, from [https://en.wikipedia.org/wiki/A*_search_algorithm]
  \bibitem{texbook}
  %Proceedings of the twenty-second international joint conference ... - IJCAI. (n.d.). Retrieved September 7, 2022, from https://www.ijcai.org/Proceedings/11/Papers/105.pdf
