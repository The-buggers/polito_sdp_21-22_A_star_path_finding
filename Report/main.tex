...
\title{Parallel A* Project} % The article title

\author{
	\authorstyle{Lorenzo Ippolito\\Mattia Rosso\\Fabio Mirto} % Author
...
\lettrineabstract{This project is inteded to show a research on parallel A*}
